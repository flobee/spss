...
/**
 * The value label records documented in this section are used for numeric and
 * short string variables only.
 * Long string variables may have value labels, but their value labels are
 * recorded using a different record type
 *
    ...
    extends Record
{
     ...
     * labels; String variables wider than 8 bytes may not be specified in this
     * list.
     *
     * @var array
     */
    ...
    {
        /** @var int $labelCount Number of value labels present in this
         * record. */
