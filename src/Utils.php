...
class Utils
{
    ...
    /**
     * Returns the number of bytes of uncompressed case data used for writing a variable
     * of the given WIDTH to a system file.
    ...
    public static function segmentAllocWidth( $width, $segment = 0 )
    {
        ...
        if ( $segment < $segmentCount - 1 ) {
            return Variable::REAL_VLS_CHUNK;
        } else {
            return ( $width - $segment * Variable::EFFECTIVE_VLS_CHUNK );
        }
    }


    /**
     * Returns the number of bytes to allocate to the given SEGMENT within a variable of
     * the given width.
     * This is the same as.
     *
     * @param mixed $width
